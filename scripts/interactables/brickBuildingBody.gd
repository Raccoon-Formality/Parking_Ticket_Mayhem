...
func _ready():
	$buidlingModel/BrickBuilding/BrickBuildingFront.material_overlay = $buidlingModel/BrickBuilding/BrickBuildingFront.material_overlay.duplicate()
	$buidlingModel/BrickBuilding2/BrickBuildingFront.material_overlay = $buidlingModel/BrickBuilding/BrickBuildingFront.material_overlay
	$buidlingModel/BrickBuilding3/BrickBuildingFront.material_overlay = $buidlingModel/BrickBuilding/BrickBuildingFront.material_overlay
	$buidlingModel/BrickBuilding4/BrickBuildingFront.material_overlay = $buidlingModel/BrickBuilding/BrickBuildingFront.material_overlay
...
func interact(pos, normal, force, gun):
	if overlay_alpha != 1.0 and not explode:
		...
		$buidlingModel/BrickBuilding/BrickBuildingFront.material_overlay.set_shader_param("alpha", overlay_alpha)
